  ...
  const webProjects: Project[] = [
    {
      id: 1,
      title: "Double Bill",
      image: "./src/assets/DoubleBill.png",
      description: "Movie Comparison App.",
    },
    {
      id: 2,
      title: "Indigo Football",
      image: "./src/assets/IndigoFootball.png",
      description: "Roster Allocation App.",
    },
    {
      id: 3,
      title: "Collection Paradise",
      image: "./src/assets/CollectionParadise.png",
      description: "Library App.",
    },
    {
      id: 4,
      title: "Eventron",
      image: "./src/assets/Eventron.png",
  ...
  const simulationProjects: Project[] = [
    {
      id: 5,
      title: "Fleet Support",
      image: "./src/assets/FleetSupport.png",
      description: "Discrete Event Simulation Project.",
    },
    {
      id: 6,
      title: "Crew Movement",
      image: "./src/assets/CrewMovement.png",
      description: "Discrete Event Simulation Project.",
    },
    {
      id: 7,
      title: "Assembly Simulation",
      image: "./src/assets/ComponentAssembly.png",
      description: "Discrete Event Simulation Project.",
    },
  ];
